...
CREATE TABLE IF NOT EXISTS songplays(songplay_id BIGSERIAL, start_time int8, user_id int8, level varchar, song_id varchar, artist_id varchar, session_id int8, location varchar, user_agent varchar);
""")

user_table_create = ("""
CREATE TABLE IF NOT EXISTS users(user_id int8 PRIMARY KEY, first_name varchar, last_name varchar, gender varchar(1), level varchar);
""")
