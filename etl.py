...
def process_log_file(cur, filepath):
    ...
    time_data = (df.ts.values, t.dt.hour.values.tolist(), t.dt.day.values.tolist(), t.dt.weekofyear.values.tolist(), t.dt.month.values.tolist(), t.dt.year.values.tolist(), t.dt.weekday.values.tolist())
